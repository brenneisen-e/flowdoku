...
export const events: DeloitteEvent[] = [
  {
    ...
    description:
      'Join us for an interactive M&A Activation Session covering end-to-end deal processes, networking, and best practices.',
    maxParticipants: 50,
    currentParticipants: 18,
    waitlistCount: 0,
    imageUrl: '/images/e2e-ma.jpg',
    eventSpecificFields: [
      {
        id: 'dietary',
        ...
        type: 'select',
        required: false,
        options: ['None', 'Vegetarian', 'Vegan', 'Halal', 'Kosher', 'Other'],
      },
    ],
  },
  {
    ...
    eventSpecificFields: [
      {
        ...
        helpText: 'Please select your T-Shirt size for the event.',
      },
    ],
  },
  {
    ...
    description:
      'SR&T Partner, Managing Director & Director Meeting at The Stage in Düsseldorf.',
    maxParticipants: 250,
    currentParticipants: 19,
    waitlistCount: 0,
    imageUrl: '/images/srt-meeting.jpg',
    eventSpecificFields: [],
  },
  {
    id: 'e4',
    ...
    description:
      'B2Run Firmenlauf in Düsseldorf. 6km Lauf rund um die Merkur Spiel-Arena. Lauft mit eurem Deloitte Team!',
    maxParticipants: 100,
    currentParticipants: 42,
    waitlistCount: 0,
    imageUrl: '/images/b2run.jpg',
    eventSpecificFields: [
      {
        id: 'tshirt',
        label: 'T-Shirt Size',
      ...
      },
      {
        ...
        type: 'select',
        required: true,
        options: ['6km Run', '6km Nordic Walking'],
      },
      {
        id: 'team',
        label: 'Team Name',
...
export const myRegistrations: Registration[] = [
  {
    id: 'r1',
    eventId: 'e2',
    eventTitle: 'JPMorgan Lauf || Warteliste',
    salutation: 'Herr',
    firstName: 'Eike',
    surname: 'Brenneisen',
    email: 'ebrenneisen@deloitte.de',
    status: 'Waitlist',
    registrationDate: '2026-03-10T14:30:00',
    waitlistPosition: 3,
  ...
  },
  {
    id: 'r2',
    eventId: 'e4',
    eventTitle: 'B2Run Düsseldorf 2026',
    salutation: 'Herr',
    firstName: 'Eike',
    surname: 'Brenneisen',
    email: 'ebrenneisen@deloitte.de',
    status: 'Registered',
    registrationDate: '2026-03-05T09:00:00',
