...
// Version als TypeScript-Konstante schreiben
const versionTsPath = path.join(rootDir, 'src', 'webparts', 'dexEventPlatform', 'version.ts');
fs.writeFileSync(versionTsPath, `// Auto-generated by bump-version.js\nexport const APP_VERSION = '${newVersion}';\n`);
