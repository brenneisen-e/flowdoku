...
const PERMISSIONS: PermissionRow[] = [
  ...
  { category: 'Event-Verwaltung', feature: 'Team-Anmeldung konfigurieren',
    description: 'In Schritt 4 (Team-Anmeldung) Toggle „Team-Anmeldung erlauben", Team-Größe (Default 4, Min 2, Max 20) und Toggle „Team-Namen abfragen" einstellen. Eingeführt mit v11.80 als reine Konfiguration — die tatsächliche Multi-Person-Anmelde-Logik (Form, automatische Mails, Outlook-Einladungen, Slot-Beitritt) folgt mit v11.81+.',
    user: false, assistenz: false, coorganizer: 'Eigene', testteam: false, checkin: false, organizer: 'Eigene', admin: true },
