...
const PERMISSIONS: PermissionRow[] = [
  ...
  { category: 'Event-Verwaltung', feature: 'Anrede-Toggle pro Event',
    ...
    user: false, assistenz: false, coorganizer: 'Eigene', testteam: false, checkin: false, organizer: 'Eigene', admin: true },
  { category: 'Event-Verwaltung', feature: 'Datei-Upload-Feld konfigurieren',
    description: 'In Schritt 5 (Felder) ein Custom-Field vom Typ „Datei-Upload" anlegen — optional als Pflichtfeld. Der Teilnehmer lädt dann bei der Anmeldung eine Datei hoch (PDF/Bild/Office, max. 15 MB); sie wird als Dokument an seine Zeile in der Teilnehmerliste angehängt und ist im Admin Center pro Teilnehmer über den „Datei"-Button abrufbar. Eingeführt mit v18.73 (normale Anmeldung inkl. „für andere"; Team-/Sub-Event-Felder folgen).',
    user: false, assistenz: false, coorganizer: 'Eigene', testteam: false, checkin: false, organizer: 'Eigene', admin: true },
  ...
  { category: 'Registrierungen', feature: 'Offenem Team beitreten (Beitritt aus Anmelde-Seite)',
    description: 'Wenn der Organizer „Offene Slots öffentlich sichtbar" aktiviert hat, sehen alle Teilnehmer auf der Event-Anmeldeseite oberhalb des Formulars eine Box mit allen unvollständigen Teams (Team-Name, Belegung — Mitgliedernamen aus Datenschutzgründen ausgeblendet). Klick auf „Beitreten" meldet direkt an; Klick auf „Beitritt anfragen" (wenn der Organizer Approval verlangt) legt eine Anfrage in der Approve-Queue an. Eingeführt mit v11.83.',
    user: true, assistenz: true, coorganizer: true, testteam: true, checkin: false, organizer: true, admin: true },
  ...
  { category: 'Event-Verwaltung', feature: 'People-Picker-Feld → Person auf CC der An-/Abmelde-Mail (v18.41)',
    ...
    user: false, assistenz: false, coorganizer: 'Eigene Events ²', testteam: false, checkin: false, organizer: 'Eigene Events ²', admin: true },
  { category: 'Teilnehmerverwaltung', feature: 'Self-Check-in aktivieren + QR/Live-Anzeige bereitstellen (v18.33)',
    description: 'Self-Check-in pro Event im Wizard (Kapazität & Sichtbarkeit) aktivieren, optionales Zeitfenster setzen und im Admin Center das druckbare QR-PDF herunterladen bzw. die rotierende Live-Anzeige öffnen. Teilnehmer scannen den event-spezifischen QR-Code mit der Handy-Kamera und checken sich selbst ein.',
    user: false, assistenz: false, coorganizer: 'Eigene Events ²', testteam: false, checkin: false, organizer: 'Eigene Events ²', admin: true },
