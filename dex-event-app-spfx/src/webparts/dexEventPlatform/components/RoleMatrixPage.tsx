...
const PERMISSIONS: PermissionRow[] = [
  ...
  { category: 'Event-Verwaltung', feature: 'Ehemals aktive Events löschen (mit echten Anmeldungen)',
    description: 'Events, die einmal aktiv waren und Anmeldungen über das Organizer-Team hinaus hatten, dürfen NUR Admins löschen — und erst 3 Monate nach dem Event-Ende (die Teilnehmerliste wird 3 Monate aufbewahrt).',
    user: false, assistenz: false, coorganizer: false, testteam: false, checkin: false, organizer: false, admin: 'Erst nach 3 Monaten' },
  ...
  { category: 'Administration', feature: 'Hintergrund-Daten archivieren (Mails/Kalender/Protokolle)',
    description: 'Zeilen abgelaufener Events aus den Arbeitslisten ins Archiv (DEX_Archive) verschieben, damit diese schlank bleiben. Die Teilnehmerliste selbst wird separat behandelt: 3 Monate nach dem Event gelöscht, die Kennzahlen wandern ins Statistik-Archiv (DEX_EventStats).',
    user: false, assistenz: false, coorganizer: false, testteam: false, checkin: false, organizer: false, admin: true },
