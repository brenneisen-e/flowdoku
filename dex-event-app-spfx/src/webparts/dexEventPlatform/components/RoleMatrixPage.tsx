...
const PERMISSIONS: PermissionRow[] = [
  ...
  { category: 'Event-Verwaltung', feature: 'People-Picker-Feld → Person auf CC der An-/Abmelde-Mail (v18.41)',
    ...
    user: false, assistenz: false, coorganizer: 'Eigene Events ²', testteam: false, checkin: false, organizer: 'Eigene Events ²', admin: true },
  { category: 'Teilnehmerverwaltung', feature: 'Self-Check-in aktivieren + QR/Live-Anzeige bereitstellen (v18.33, v20.1: immer verfügbar)',
    description: 'Self-Check-in ist grundsätzlich für jedes Event verfügbar: QR-PDF herunterladen bzw. rotierende Live-Anzeige öffnen — direkt auf der Check-in-Seite, im Admin Center oder aus dem QR-Versand-Modal. Beim ersten Klick wird Self-Check-in automatisch aktiviert (Token wird am Event gespeichert — erfordert Organizer-/Admin-Rechte; danach kann auch das Check-in-Team die Anzeige/das PDF nutzen). Zeitfenster + gezieltes Deaktivieren weiterhin im Wizard (Kapazität & Sichtbarkeit). Teilnehmer scannen den event-spezifischen QR-Code mit der Handy-Kamera und checken sich selbst ein.',
    user: false, assistenz: false, coorganizer: 'Eigene Events ²', testteam: false, checkin: 'Wenn bereits aktiviert', organizer: 'Eigene Events ²', admin: true },
