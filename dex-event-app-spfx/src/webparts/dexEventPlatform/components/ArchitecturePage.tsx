...
export default function ArchitecturePage(): React.ReactElement {
  ...
  const coreLists: Item[] = [
    ...
    { name: 'DEX_Roles', de: 'Rollen: User, Organizer, Admin, IT-Admin, F&A (wie Organizer, plus Zugriff aufs F&A Center).', en: 'Roles: user, organizer, admin, IT admin, F&A (like organizer, plus access to the F&A center).', link: true },
