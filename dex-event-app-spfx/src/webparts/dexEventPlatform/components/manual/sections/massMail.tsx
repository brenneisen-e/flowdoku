            ...
            description: (
              <>
                ...
                <ul style={{ margin: '10px 0 0', paddingLeft: 20, lineHeight: 1.6 }}>
                  ...
                  <li>{isDe
                    ? <><strong>Erinnerung (noch nicht geantwortet)</strong> — alle, die das Event sehen, sich aber weder angemeldet noch abgemeldet noch abgesagt haben; dieselbe Liste wie &bdquo;Wer hat noch nicht geantwortet?&ldquo; in der Sichtbarkeits-Karte, das Organizer-Team zählt nicht. Nur wenn die Sichtbarkeit allein über den Standort läuft, kennt DEX keine Eingeladenen — dann fügst du im nächsten Schritt deinen Einladungs-Verteiler ein.</>
                    : <><strong>Reminder (not responded yet)</strong> — everyone who can see the event but has neither registered nor cancelled nor declined; the same list as &ldquo;Who has not responded yet?&rdquo; in the visibility card, the organizer team does not count. Only if visibility runs via location alone does DEX know no invitees — then you paste your invitation list in the next step.</>}</li>
                  <li>{isDe
