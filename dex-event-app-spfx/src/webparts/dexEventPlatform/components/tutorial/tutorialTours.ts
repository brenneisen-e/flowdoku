...
const ORGANIZER_TOUR: TutorialTour = {
  ...
  descDe: 'Events anlegen mit dem Wizard (alle 10 Schritte), Teilnehmer verwalten im Organizer Center und der Check-in am Eventtag.',
  descEn: 'Create events with the wizard (all 10 steps), manage attendees in the Organizer Center and run check-in on the event day.',
  steps: [
    {
      page: 'start',
    ...
    },
    {
      ...
      bodyDe: 'Über diesen Button startest du den Event-Wizard. Wir gehen jetzt gemeinsam alle 10 Schritte durch — keine Sorge, es wird dabei nichts gespeichert.',
      bodyEn: 'This button starts the event wizard. We will now walk through all 10 steps together — don’t worry, nothing gets saved.',
    },
    {
      page: 'create-event',
      wizardStep: 0,
      ...
      bodyDe: 'Titel, Zeitraum, Beschreibung, Event-Bild und dein Organizer-Team. Hier legst du auch fest, ob das Event als Entwurf startet — sichtbar wird es erst, wenn du es live schaltest.',
      bodyEn: 'Title, dates, description, event image and your organizer team. Here you also decide whether the event starts as a draft — it only becomes visible once you publish it.',
    },
    {
      page: 'create-event',
      wizardStep: 1,
    ...
    },
    {
      ...
      titleDe: 'Schritt 3 — Sub-Events',
      titleEn: 'Step 3 — Sub-events',
      bodyDe: 'Optional: Programmpunkte oder Sessions mit eigener Kapazität, eigenem Termin und eigener Teilnehmerliste — z.B. Workshops oder ein Networking-Dinner. Teilnehmer wählen sie bei der Anmeldung dazu.',
      bodyEn: 'Optional: program items or sessions with their own capacity, schedule and attendee list — e.g. workshops or a networking dinner. Attendees pick them during registration.',
    },
    {
      page: 'create-event',
      wizardStep: 3,
      selector: '[data-tour="wizard-step-3"]',
      titleDe: 'Schritt 4 — Ort & Programm',
      titleEn: 'Step 4 — Location & programme',
    ...
    },
    {
      ...
      titleDe: 'Schritt 5 — Kapazität & Sichtbarkeit',
      titleEn: 'Step 5 — Capacity & visibility',
    ...
    },
    {
      ...
      titleDe: 'Schritt 6 — Felder',
      titleEn: 'Step 6 — Fields',
    ...
    },
    {
      ...
      titleDe: 'Schritt 7 — Kommunikation',
      titleEn: 'Step 7 — Communication',
    ...
    },
    {
      ...
      titleDe: 'Schritt 8 — Team-Anmeldung',
      titleEn: 'Step 8 — Team registration',
    ...
    },
    {
      ...
      titleDe: 'Schritt 9 — Dokumente',
      titleEn: 'Step 9 — Documents',
    ...
    },
    {
      page: 'create-event',
      wizardStep: 9,
      selector: '[data-tour="wizard-step-9"]',
      titleDe: 'Schritt 10 — Fun-Zone',
      titleEn: 'Step 10 — Fun zone',
