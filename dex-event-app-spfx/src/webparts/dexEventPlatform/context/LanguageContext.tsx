...
const translations: Record<Locale, Record<string, string>> = {
  de: {
    ...
    'create.eventlogo.hint': 'Ersetzt das DEX-Logo in E-Mail Header und Outlook-Termin. Deloitte-Logo bleibt immer. Max. 200px breit, wird automatisch komprimiert.',
  ...
  en: {
    ...
    'create.eventlogo.hint': 'Replaces the DEX logo in email header and Outlook calendar entry. Deloitte logo always stays. Max. 200px wide, auto-compressed.',
