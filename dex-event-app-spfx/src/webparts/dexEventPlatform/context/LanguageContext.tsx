...
const translations: Record<Locale, Record<string, string>> = {
  de: {
    ...
    'reg.subevents.hint': 'Du kannst dich hier zusätzlich für einzelne Sessions anmelden. Pro Session bekommst du eine eigene Bestätigungs-E-Mail und einen eigenen Outlook-Kalendereintrag.',
  ...
  en: {
    ...
    'reg.subevents.hint': 'You can register for individual sessions here. You will receive a separate confirmation email and calendar invite per session.',
