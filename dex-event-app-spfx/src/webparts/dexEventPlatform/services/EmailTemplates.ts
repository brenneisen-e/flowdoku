    ...
    return {
      ...
      body: wrapTemplate(
        ...
        <ol style="margin:12px 0 0 18px;padding:0;line-height:1.7;">
          ...
          <li>Der <strong>fertige Einladungs-Entwurf (.eml) hängt direkt an dieser Mail</strong>. An, Betreff und Text sind vorausgefüllt (an die externe Person; no_reply + Organisator:innen in Kopie) — Anhang in Outlook öffnen und auf <strong>&bdquo;Senden&ldquo;</strong> klicken. <span style="color:#555;">(Zeigt Outlook die Datei als empfangene Mail an, nutze einfach &bdquo;Weiterleiten&ldquo;. Fehlt der Anhang, findest du den Entwurf jederzeit in der Teilnehmerzeile von ${externalName} im Organizer Center zum Download.)</span></li>
  ...
  return {
    ...
    body: wrapTemplate(
      ...
      <ol style="margin:12px 0 0 18px;padding:0;line-height:1.7;">
        ...
        <li>The <strong>ready-made invitation draft (.eml) is attached to this email</strong>. To, subject and text are pre-filled (to the external person; no_reply + organizers in copy) — open the attachment in Outlook and click <strong>&ldquo;Send&rdquo;</strong>. <span style="color:#555;">(If Outlook shows the file as a received mail, simply use &ldquo;Forward&rdquo;. If the attachment is missing, you can always download the draft from ${externalName}'s row in the Organizer Center.)</span></li>
