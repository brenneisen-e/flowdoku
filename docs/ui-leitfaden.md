...
| `dex-ui-checkbox` | Seit v31.11 die Klasse für **jede Checkbox ausserhalb** einer `dex-ui-toggle-row` (z.B. Spaltenwahl der Teilnehmerliste). Gleiches Bild wie unten — eckig mit weißem Haken. Ohne sie gewinnt das globale SCSS und macht einen Kreis daraus |
